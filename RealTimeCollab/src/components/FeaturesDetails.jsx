    ...
    <div className="min-h-screen bg-white px-4 py-20">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mb-20 text-center">
          <h1 className="mb-8 text-6xl leading-[1.1] font-bold tracking-tight text-gray-900 ]">
            Everything You Need for
            <br />
            <span className="text-blue-500">Creative Collaboration</span>
          </h1>
          <p className="mx-auto max-w-3xl text-lg leading-relaxed font-normal text-neutral-500">
        ...
        <div className="mx-auto max-w-6xl overflow-hidden bg-white">
          ...
          <div className="grid grid-cols-3 border-b border-gray-200">
            {/* Top Left */}
            <div className="group relative border-r border-gray-200 from-gray-100 to-transparent/90 p-12 transition-all duration-300 hover:bg-gradient-to-t">
            ...
            {/* Top Right */}
            <div className="group relative from-gray-100 to-transparent/90 p-12 transition-all duration-300 hover:bg-gradient-to-t">
              <div
          ...
          <div className="grid grid-cols-2">
            ...
            {/* Bottom Right */}
            <div className="group relative from-gray-100/90 to-transparent/90 p-12 transition-all duration-300 hover:bg-gradient-to-t">
              <div
                className="absolute inset-0 opacity-0 transition-opacity duration-300 group-hover:opacity-100"
                style={{
                  backgroundImage: `radial-gradient(circle, #d1d5db 1.15px, transparent 1px)`,
