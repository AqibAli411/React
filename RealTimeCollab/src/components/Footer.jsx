      ...
      <div className="mx-auto max-w-7xl px-6 py-12 pb-4">
        ...
        <div className="mb-8 grid grid-cols-1 gap-8 md:grid-cols-3">
          ...
          <div className="space-y-3">
            <h3 className="text-xl font-bold text-blue-600">Aqib Ali</h3>
          ...
          <div className="flex flex-col items-start justify-center space-y-4">
            ...
            <div className="space-y-3">
              <a
                ...
                className="group flex items-center space-x-3 text-gray-600 transition-colors duration-200 hover:text-blue-600"
              >
                <Github
                  size={20}
